      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              MyBloodTypeDonorListBtn(text: "A", onTap: () => showBloodTypeDonorList("A")),
              MyBloodTypeDonorListBtn(text: "B", onTap: () => showBloodTypeDonorList("B")),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              MyBloodTypeDonorListBtn(text: "AB", onTap: () => showBloodTypeDonorList("AB")),
              MyBloodTypeDonorListBtn(text: "O", onTap: () => showBloodTypeDonorList("O")),
            ],
          ),
        ],
      ),
